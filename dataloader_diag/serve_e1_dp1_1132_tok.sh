...
nohup vllm serve /home/y50063564/Qwen3-4B --host 0.0.0.0 --port 1132 \
  ...
  --kv_transfer_config "{\"kv_connector\": \"ExampleHiddenStatesConnector\", \"kv_role\": \"kv_producer\", \"kv_connector_extra_config\": {\"shared_storage_path\": \"$D/_hs_e1_tok\"}}" \
  --max-num-batched-tokens ${MAX_NUM_BATCHED_TOKENS:-4096} \
  --no-enable-chunked-prefill > "$LOG" 2>&1 &
echo $! > "$D/logs/vllm_e1_tok.pid"
echo "diag server log: $LOG  pid: $(cat $D/logs/vllm_e1_tok.pid)"
