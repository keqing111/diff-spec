#!/bin/bash
# 实验A: Diff@layer0, 5 层(其余 4 层 GQA), 单卡 12 训练。
...
OUTPUT_DIR="/home/y50063564/processed_data/dspark_data/dspark_diff_l0_5l"
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/train_l0_5l_$(date +%Y%m%d_%H%M%S).log"
PID_FILE="$LOG_DIR/train.pid"

echo "=== Diff@layer0 5层 (卡12): Training on NPU: $TRAIN_NPUS ==="
