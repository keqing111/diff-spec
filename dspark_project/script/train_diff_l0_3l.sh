#!/bin/bash
# 实验C: 3 层模型, Diff@layer0, 其余 2 层 GQA, 单卡 14 训练。
...
OUTPUT_DIR="/home/y50063564/processed_data/dspark_data/dspark_diff_l0_3l"
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/train_l0_3l_$(date +%Y%m%d_%H%M%S).log"
PID_FILE="$LOG_DIR/train.pid"

echo "=== Diff@layer0 3层 (卡14): Training on NPU: $TRAIN_NPUS ==="
