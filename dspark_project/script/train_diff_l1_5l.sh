#!/bin/bash
# 实验B: Diff@layer1, 5 层(其余 4 层 GQA), 单卡 13 训练。
# 其余配置与之前训练一致; vLLM 在卡 15。
...
OUTPUT_DIR="/home/y50063564/processed_data/dspark_data/dspark_diff_l1_5l"
...
DIFF_ATTENTION_LAYER_INDICES="1"
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/train_l1_5l_$(date +%Y%m%d_%H%M%S).log"
PID_FILE="$LOG_DIR/train.pid"

echo "=== Diff@layer1 5层 (卡13): Training on NPU: $TRAIN_NPUS ==="
