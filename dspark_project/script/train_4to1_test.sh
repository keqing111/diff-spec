#!/bin/bash
# 4:1 比例测试用训练脚本(独立,不影响生产:4 rank 卡 11-14 / 端口 1124 / 独立输出目录)
# 用法: 先起 vllm_serve_4to1_test.sh,再起本脚本
...
DATASET="sharegpt"
OUTPUT_DIR="/home/y50063564/processed_data/dspark_data/ratio_test"
...
# Ascend NPU assignments (测试: 4 trainer, 1 server on card 10)
TRAIN_NPUS="11,12,13,14"
NUM_TRAIN_NPUS=4
...
echo "=== Step 3 (ratio 4:1 test): Training on Ascend NPU(s): $TRAIN_NPUS ==="
