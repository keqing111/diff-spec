#!/bin/bash
# 单副本 vLLM server(卡 15),服务 3 组单卡 trainer(卡 12/13/14)。
# 前提: /home/y50063564/Qwen3-4B 与数据目录需存在; 卡 15 空闲。
# 用法: 先起本脚本, 再起 train_diff_*_*.sh。
...
vllm serve /home/y50063564/Qwen3-4B \
    ...
    --kv_transfer_config '{"kv_connector": "ExampleHiddenStatesConnector", "kv_role": "kv_producer", "kv_connector_extra_config": {"shared_storage_path": "/home/y50063564/processed_data/dspark_data/hs_shared"}}' \
