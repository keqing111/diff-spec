...
class DFlashSpeculatorConfig(SpeculatorModelConfig):
    ...
    diff_attention_layer_indices: list[int] = Field(
        default_factory=list,
        description="Draft layer indices that use Diff-Transformer (diffv1) attention "
        "instead of GQA. Empty = no diff layers (default, identical to previous "
        "behavior).",
    )
